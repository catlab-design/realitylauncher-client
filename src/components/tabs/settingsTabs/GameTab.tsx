            ...
            <div className="p-4 space-y-4">
                ...
                <div>
                    <div className="flex items-center justify-between mb-1">
                        <p className="font-medium text-sm" style={{ color: colors.onSurface }}>{t('memory_allocated')}</p>
                        <input
                            type="number"
                            value={config.ramMB}
                ...
                {/* Minecraft Directory */}
                <div>
                    <p className="font-medium text-sm mb-2" style={{ color: colors.onSurface }}>{t('minecraft_folder')}</p>
                ...
                {/* Java Arguments */}
                <div>
                    <p className="font-medium text-sm mb-2" style={{ color: colors.onSurface }}>{t('java_args')}</p>
