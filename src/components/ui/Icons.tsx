...
export const Icons = {
    ...
    Unlock: (props: IconProps) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
            <path d="M12 17c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm6-9h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6h1.9c0-1.71 1.39-3 3.1-3s3.1 1.29 3.1 3v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm0 12H6V10h12v10z" />
        </svg>
    ),
    ...
    Sparkle: (props: IconProps) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
            <path d="M19 9l1.25-2.75L23 5l-2.75-1.25L19 1l-1.25 2.75L15 5l2.75 1.25L19 9zm-7.5.5L9 4l-2.5 5.5L1 12l5.5 2.5L9 20l2.5-5.5L17 12l-5.5-2.5zM19 15l-1.25 2.75L15 19l2.75 1.25L19 23l1.25-2.75L23 19l-2.75-1.25L19 15z"/>
        </svg>
    ),
    Sun: (props: IconProps) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    ...
    Facebook: (props: IconProps) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
            <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H7v-3h3v-2.29c0-2.97 1.76-4.66 4.53-4.66 1.32 0 2.7.24 2.7.24v2.97h-1.52c-1.47 0-1.93.91-1.93 1.84V12h3.32l-.53 3h-2.79v6.8c4.56-.93 8-4.96 8-9.8z" />
        </svg>
    ),
    ...
    Hanger: (props: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor" stroke="currentColor" strokeWidth="25" {...props}>
